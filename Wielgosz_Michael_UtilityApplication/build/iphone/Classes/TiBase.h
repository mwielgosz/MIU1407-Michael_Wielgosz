...
// in simulator we redefine to format for Wielgosz_Michael_UtilityApplication Developer console
...
{\
	NSString * exceptionName = [@"org.wielgosz_michael_utilityapplication." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.wielgosz_michael_utilityapplication";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWielgosz_Michael_UtilityApplicationNativeItemNone = -1, 
	UIWielgosz_Michael_UtilityApplicationNativeItemSpinner = -2,
	UIWielgosz_Michael_UtilityApplicationNativeItemProgressBar = -3,
	
	UIWielgosz_Michael_UtilityApplicationNativeItemSlider = -4,
	UIWielgosz_Michael_UtilityApplicationNativeItemSwitch = -5,
	UIWielgosz_Michael_UtilityApplicationNativeItemMultiButton = -6,
	UIWielgosz_Michael_UtilityApplicationNativeItemSegmented = -7,
	
	UIWielgosz_Michael_UtilityApplicationNativeItemTextView = -8,
	UIWielgosz_Michael_UtilityApplicationNativeItemTextField = -9,
	UIWielgosz_Michael_UtilityApplicationNativeItemSearchBar = -10,
	
	UIWielgosz_Michael_UtilityApplicationNativeItemPicker = -11,
	UIWielgosz_Michael_UtilityApplicationNativeItemDatePicker = -12,
	
	UIWielgosz_Michael_UtilityApplicationNativeItemInfoLight = -13,
	UIWielgosz_Michael_UtilityApplicationNativeItemInfoDark = -14,
	
	UIWielgosz_Michael_UtilityApplicationNativeItemDisclosure = -15,
	
	UIWielgosz_Michael_UtilityApplicationNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Wielgosz_Michael_UtilityApplication instances of
