...
//@interface Wielgosz_Michael_UtilityApplicationObject : NSObject
//@end

@interface Wielgosz_Michael_UtilityApplicationObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Wielgosz_Michael_UtilityApplicationObject class]])
		{
			for (NSString *key in [[(Wielgosz_Michael_UtilityApplicationObject*)o modules] allKeys])
			{
