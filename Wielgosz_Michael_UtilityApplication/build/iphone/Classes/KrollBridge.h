...
@interface Wielgosz_Michael_UtilityApplicationObject : KrollCoverageObject {
#else
@interface Wielgosz_Michael_UtilityApplicationObject : KrollObject {
#endif
@private
...
extern NSString * Wielgosz_Michael_UtilityApplication$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Wielgosz_Michael_UtilityApplicationObject *_wielgosz_michael_utilityapplication;
    KrollObject* console;
	BOOL shutdown;
