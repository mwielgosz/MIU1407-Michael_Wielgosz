 ...
 * to send analytic data that can be viewed on the Wielgosz_Michael_UtilityApplication Dashboard.
 *
 * For information on getting started with Wielgosz_Michael_UtilityApplication Platform Services,
