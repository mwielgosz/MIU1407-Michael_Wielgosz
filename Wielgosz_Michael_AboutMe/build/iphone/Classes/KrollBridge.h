...
@interface Wielgosz_Michael_AboutMeObject : KrollCoverageObject {
#else
@interface Wielgosz_Michael_AboutMeObject : KrollObject {
#endif
@private
...
extern NSString * Wielgosz_Michael_AboutMe$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Wielgosz_Michael_AboutMeObject *_wielgosz_michael_aboutme;
    KrollObject* console;
	BOOL shutdown;
