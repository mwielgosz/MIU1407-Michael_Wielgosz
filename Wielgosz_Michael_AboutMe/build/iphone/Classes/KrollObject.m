...
//@interface Wielgosz_Michael_AboutMeObject : NSObject
//@end

@interface Wielgosz_Michael_AboutMeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Wielgosz_Michael_AboutMeObject class]])
		{
			for (NSString *key in [[(Wielgosz_Michael_AboutMeObject*)o modules] allKeys])
			{
