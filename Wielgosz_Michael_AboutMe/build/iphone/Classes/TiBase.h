...
// in simulator we redefine to format for Wielgosz_Michael_AboutMe Developer console
...
{\
	NSString * exceptionName = [@"org.wielgosz_michael_aboutme." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.wielgosz_michael_aboutme";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWielgosz_Michael_AboutMeNativeItemNone = -1, 
	UIWielgosz_Michael_AboutMeNativeItemSpinner = -2,
	UIWielgosz_Michael_AboutMeNativeItemProgressBar = -3,
	
	UIWielgosz_Michael_AboutMeNativeItemSlider = -4,
	UIWielgosz_Michael_AboutMeNativeItemSwitch = -5,
	UIWielgosz_Michael_AboutMeNativeItemMultiButton = -6,
	UIWielgosz_Michael_AboutMeNativeItemSegmented = -7,
	
	UIWielgosz_Michael_AboutMeNativeItemTextView = -8,
	UIWielgosz_Michael_AboutMeNativeItemTextField = -9,
	UIWielgosz_Michael_AboutMeNativeItemSearchBar = -10,
	
	UIWielgosz_Michael_AboutMeNativeItemPicker = -11,
	UIWielgosz_Michael_AboutMeNativeItemDatePicker = -12,
	
	UIWielgosz_Michael_AboutMeNativeItemInfoLight = -13,
	UIWielgosz_Michael_AboutMeNativeItemInfoDark = -14,
	
	UIWielgosz_Michael_AboutMeNativeItemDisclosure = -15,
	
	UIWielgosz_Michael_AboutMeNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Wielgosz_Michael_AboutMe instances of
