 ...
 * to send analytic data that can be viewed on the Wielgosz_Michael_AboutMe Dashboard.
 *
 * For information on getting started with Wielgosz_Michael_AboutMe Platform Services,
