...
/**
 The base class for all Wielgosz_Michael_AboutMe modules
 */
...
/**
 Wielgosz_Michael_AboutMe Platform calls this method on startup.
 */
-(void)startup;

/**
 Wielgosz_Michael_AboutMe Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Wielgosz_Michael_AboutMe Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Wielgosz_Michael_AboutMe Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Wielgosz_Michael_AboutMe Platform calls this method on resume.
 @param sender The sender of the event.
 */
