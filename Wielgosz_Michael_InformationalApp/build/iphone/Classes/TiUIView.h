...
/**
 Base class for all Wielgosz_Michael_InformationalApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Wielgosz_Michael_InformationalApp view hierarchy (such as wrapped iOS UIViews) was touched.
