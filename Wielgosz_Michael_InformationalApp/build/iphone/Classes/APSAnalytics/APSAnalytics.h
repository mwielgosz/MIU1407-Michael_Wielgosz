 ...
 * to send analytic data that can be viewed on the Wielgosz_Michael_InformationalApp Dashboard.
 *
 * For information on getting started with Wielgosz_Michael_InformationalApp Platform Services,
