...
@interface Wielgosz_Michael_InformationalAppObject : KrollCoverageObject {
#else
@interface Wielgosz_Michael_InformationalAppObject : KrollObject {
#endif
@private
...
extern NSString * Wielgosz_Michael_InformationalApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Wielgosz_Michael_InformationalAppObject *_wielgosz_michael_informationalapp;
    KrollObject* console;
	BOOL shutdown;
