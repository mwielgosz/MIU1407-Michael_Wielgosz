...
//Rare exceptions to indicate a bug in the _wielgosz_michael_informationalapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Wielgosz_Michael_InformationalApp proxies.
 */
