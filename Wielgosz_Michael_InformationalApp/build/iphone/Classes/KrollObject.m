...
//@interface Wielgosz_Michael_InformationalAppObject : NSObject
//@end

@interface Wielgosz_Michael_InformationalAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Wielgosz_Michael_InformationalAppObject class]])
		{
			for (NSString *key in [[(Wielgosz_Michael_InformationalAppObject*)o modules] allKeys])
			{
