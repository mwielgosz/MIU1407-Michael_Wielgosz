...
// in simulator we redefine to format for Wielgosz_Michael_InformationalApp Developer console
...
{\
	NSString * exceptionName = [@"org.wielgosz_michael_informationalapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.wielgosz_michael_informationalapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWielgosz_Michael_InformationalAppNativeItemNone = -1, 
	UIWielgosz_Michael_InformationalAppNativeItemSpinner = -2,
	UIWielgosz_Michael_InformationalAppNativeItemProgressBar = -3,
	
	UIWielgosz_Michael_InformationalAppNativeItemSlider = -4,
	UIWielgosz_Michael_InformationalAppNativeItemSwitch = -5,
	UIWielgosz_Michael_InformationalAppNativeItemMultiButton = -6,
	UIWielgosz_Michael_InformationalAppNativeItemSegmented = -7,
	
	UIWielgosz_Michael_InformationalAppNativeItemTextView = -8,
	UIWielgosz_Michael_InformationalAppNativeItemTextField = -9,
	UIWielgosz_Michael_InformationalAppNativeItemSearchBar = -10,
	
	UIWielgosz_Michael_InformationalAppNativeItemPicker = -11,
	UIWielgosz_Michael_InformationalAppNativeItemDatePicker = -12,
	
	UIWielgosz_Michael_InformationalAppNativeItemInfoLight = -13,
	UIWielgosz_Michael_InformationalAppNativeItemInfoDark = -14,
	
	UIWielgosz_Michael_InformationalAppNativeItemDisclosure = -15,
	
	UIWielgosz_Michael_InformationalAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Wielgosz_Michael_InformationalApp instances of
