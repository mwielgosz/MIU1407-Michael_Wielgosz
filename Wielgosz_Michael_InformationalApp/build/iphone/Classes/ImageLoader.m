...
-(void)request:(APSHTTPRequest *)request onLoad:(APSHTTPResponse *)response
{
	...
	if ([req cancelled]==NO)
	{
		...
		if (data == nil || [data length]==0)
		{
			...
			NSError *error = [NSError errorWithDomain:@"com.wielgosz_michael_informationalapp._wielgosz_michael_informationalapp.imageloader" code:1 userInfo:errorDetail];
